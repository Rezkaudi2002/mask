...
const FactoryService = () => {
  ...
  const strengths = [
    {
      title: "1. 一括対応で手間削減",
      content: "買取・撤去・清掃まですべて当社で対応。（不用品の回収は行っておりません）"
    },
    {
      title: "2. コスト最適化",
      content: "買取可能な設備は適正価格で買取し、処分費用から相殺。トータルコストを削減します。"
    },
    {
      title: "3. 豊富な実績",
      content: "創業以来、様々な工場整理を手がけ、あらゆる業種・規模に対応してきました。"
    },
    {
      title: "4. 柔軟な対応力",
  ...
  const processSteps = [
    {
      ...
      content: "まずはお電話またはメール、LINE等からご相談ください。概要をお聞かせいただきます。"
    },
    {
      title: "STEP 2: 現地調査・買取査定",
      content: "専門スタッフが現地にお伺いし、現地の確認と機械設備や在庫品の査定を行います。"
    },
    {
      title: "STEP 3: お見積もり",
      content: "お見積もりを作成します。"
    },
    {
      ...
      content: "ご納得いただけましたら、お客様のご都合に合わせて作業日程を決定します。"
    },
    {
  ...
  const faqs = [
    {
      ...
      answer: "A: はい、可能です。営業に支障がないよう、エリアを区切って段階的に作業を進めることができます。"
    },
    {
      question: "Q: 土日の作業は可能ですか？",
      answer: "A: 基本的には平日営業となりますが、平日が難しい場合は休日作業にも対応いたしますのでご相談ください。"
    },
    {
      question: "Q: 見積もり後のキャンセルは可能ですか？",
      answer: "A: もちろん可能です。お見積りは無料ですので、じっくりご検討ください。"
    },
    {
      question: "Q: 機械の買取価格はどのように決まりますか？",
      answer: "A: 機種・年式・稼働状況・需要などを総合的に判断し、適正価格をご提示します。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 leading-relaxed">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-red-800 to-red-900 text-white py-20 overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-gradient-radial from-yellow-400/20 to-transparent animate-pulse"></div>
        </div>
        <div className="fs-container max-w-6xl mx-auto px-5 relative z-10">
        ...
        <div className="fs-container max-w-6xl mx-auto px-5">
          ...
          <div className="mb-15">
            ...
            <div className="bg-gray-50 border-2 border-red-800 border-t-0 p-8 rounded-b-lg">
              <h4 className="text-red-800 text-xl font-bold mb-5">高価買取対象設備</h4>
              ...
              <h4 className="text-red-800 text-xl font-bold mb-5">撤去作業の特徴</h4>
              ...
              <div key={index} className="relative mb-12 flex items-center">
                <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:text-right md:pr-8' : 'md:ml-auto md:pl-8'}`}>
                  <div className="bg-white border-2 border-yellow-400 rounded-lg p-8 shadow-md ml-12 md:ml-0">
                    <h3 className="text-red-800 text-xl font-bold mb-3">{step.title}</h3>
                    <p>{step.content}</p>
                  </div>
                </div>
      ...
      <section className="bg-gray-100 py-20">
        <div className="fs-container max-w-6xl mx-auto px-5">
          <div className="text-center mb-8">
            ...
            <h3 className="text-red-800 text-2xl font-bold mb-5">重点対応エリア</h3>
            ...
            <div className="bg-pink-100 border-2 border-dashed border-red-800 rounded-lg h-72 max-w-2xl mx-auto mt-8 flex items-center justify-center">
              <span className="text-red-800 text-xl font-bold">地図をここに配置</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="fs-container max-w-6xl mx-auto px-5">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-red-800">工場整理成功のポイント</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-pink-100 p-8 rounded-lg">
              <h3 className="text-red-800 text-xl font-bold mb-4">早めの相談が成功の鍵</h3>
            ...
            <div className="bg-pink-100 p-8 rounded-lg">
              <h3 className="text-red-800 text-xl font-bold mb-4">信頼できるパートナー選び</h3>
              <ul className="space-y-2">
                <li>• 実績と経験の確認</li>
                <li>• 許可・資格の保有</li>
                <li>• 一括対応能力</li>
